...
os.makedirs(
    "results/efficientnet_augmented",
    exist_ok=True
)
...
print("\n==============================")
print("EfficientNetB0 + Augmentation — Classification Report")
print("==============================\n")
print(report)

with open("results/efficientnet_augmented/classification_report.txt", "w") as f:
    f.write("EfficientNetB0 + Augmentation — Classification Report\n\n")
    f.write(report)
...
plt.title("EfficientNetB0 + Augmentation — Confusion Matrix")
plt.xlabel("Predicted")
plt.ylabel("Actual")
plt.tight_layout()

plt.savefig("results/efficientnet_augmented/confusion_matrix.png")
plt.close()
